...
def adofai_event_ranges() -> list[EventRange]:
    ...
    return [
        ...
        EventRange(EventType.SET_SPEED_BPM, 1, 999),
        EventRange(EventType.SET_SPEED_MULT, 1, 80),
        EventRange(EventType.PAUSE, 0, 100),
        ...
        EventRange(EventType.SCALE_MARGIN, 0, 200),
        EventRange(EventType.SCALE_RADIUS, 0, 200),
        ...
        EventRange(EventType.CAMERA_POSITION_X, -200, 200),
        EventRange(EventType.CAMERA_POSITION_Y, -200, 200),
        EventRange(EventType.CAMERA_ROTATION, 0, 359),
        EventRange(EventType.CAMERA_ZOOM, 0, 400),
        EventRange(EventType.CAMERA_DURATION, 0, 100),
        ...
        EventRange(EventType.REPEAT_EVENTS, 1, 20),
        EventRange(EventType.SET_CONDITIONAL_EVENTS, 0, 1),
        EventRange(EventType.SET_INPUT_EVENT, 0, 1),
        EventRange(EventType.FLASH, 0, 100),
        EventRange(EventType.BLOOM, 0, 200),
        EventRange(EventType.SHAKE_SCREEN, 0, 200),
        ...
        EventRange(EventType.VFX_INTENSITY, 0, 200),
        EventRange(EventType.VFX_STRENGTH, 0, 200),
        EventRange(EventType.VFX_THRESHOLD, 0, 100),
        EventRange(EventType.ANGLE_OFFSET, -180, 180),
    ]
...
def adofai_input_event_ranges() -> list[EventRange]:
    ...
    return [
        EventRange(EventType.BPM, 1, 999),
        EventRange(EventType.OFFSET, -10000, 10000),
